...
public class ManageSalesController {
    ...
    public boolean createSale(String brand, String model, int year, String carId, String color, String description, int days, long minOffer, int typeSale) throws IOException {
