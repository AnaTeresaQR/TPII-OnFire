...
public class ConcreteFactorySale extends FactorySaleInterface {
     ...
     */
    @Override
    public SaleModel createSale(AbstractBuilderCreateSale builder, SaleModel saleModel, UserModel user, String brand, String model, int year, String carId, String color, String description, int days, long minOffer) throws CustomException {
